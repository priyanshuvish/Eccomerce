...
export default function CategoriesPage() {
  ...
  // Fetch a few products for each category to show preview
  const { data: featuredProducts } = useGetProductsQuery({ limit: 10, sortBy: 'rating', order: 'desc' });
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {categories?.slice(0, 6).map((category) => (
              ...
              >
                <div className={`w-24 h-24 mx-auto rounded-full ${getCategoryColor(category.slug)} bg-opacity-20 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}>
                  {getCategoryIcon(category.slug, "w-10 h-10")}
                </div>
      ...
      <section className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-6">Get notified about new categories and products</p>
          <form 
          ...
          >
            <input
              ...
              required
              className="flex-1 px-4 py-3 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-600"
            />
            <button
              type="submit"
